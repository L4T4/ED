...
public class ArvoreExpressao {
	...
	public void montarArvore(String string){			// montar a arvore de expressoes
		...
		if(pilha1.size()==1 && pilha2.isEmpty()==true)	// caso a pilha 2 esteja vazia e a pilha1 tenha 1 elemento entao a raiz sera o ultimo elemento da pilha  	
			{this.raiz=pilha1.pop();}
		else
			{System.out.println("Erro na expressão");}	// caso contrario, a pilha2 nao esteja vazia ou a pilha 1 nao ter 1 elemento , entao tem algum erro na expressao
